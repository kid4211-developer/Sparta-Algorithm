...
# 구슬이 이동한 곳에 대한 정보를 담을 visited 생성
# 구슬은 2개 -> 각 구슬에 대한 위치정보를 4차원 배열을 통해 표현
# visited[red_marble_row][red_marble_col][blue_marble_row][blue_marble__col]
# row : n // col : m
...
def is_available_to_take_out_only_red_marble(game_map):
    ...
    # 탐색은 10번까지만 할 수 있음 -> 탐색한 횟수를 queue에 넣어줌
...
print(is_available_to_take_out_only_red_marble(map_array))  # True 를 반환해야 합니다